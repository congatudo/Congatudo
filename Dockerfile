...
ADD https://api.github.com/repos/knuspel/Congatudo/git/refs/heads/main /usr/src/version.json

# Download valetudo
RUN git clone --depth 1 https://github.com/knuspel/Congatudo --single-branch .
