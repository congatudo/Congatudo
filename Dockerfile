# Stage 1
ARG BUILD_FROM=amd64/alpine:3.16
...
ADD https://api.github.com/repos/congatudo/Congatudo/git/refs/heads/old-congatudo /usr/src/version.json

# Download valetudo
RUN git clone --depth 1 https://github.com/congatudo/Congatudo -b old-congatudo .
