...
The Congatudo updater is a convenience feature aiming to make life with Congatudo a bit easier.

As it is built with privacy in mind, you will have to manually click a button to make it search for newer versions of Congatudo.
...
It is also worth noting that the updater won't update the robots firmware. It only updates the Congatudo binary.
