...
const OPCODES = {
    ...
    "QMSG_SET_MANUAL": 0x106F,
    "RMSG_SET_MANUAL": 0x1070,
...
const COMMANDS = {
    ...
    SET_MANUAL: ["QMSG_SET_MANUAL", "RMSG_SET_MANUAL"],
};
...
class DeviceStatus {
    ...
    getStatusStateValue() {
        ...
        if ([0, 2, 4, 23, 29].includes(this.workMode)) {
...
class CecotecConga3490 {
    ...
    async startManualControl() {
        ...
        this.deviceStatus.manualControl = true;
    ...
    async stopManualControl() {
        ...
        this.deviceStatus.manualControl = false;
        this.robotState.upsertFirstMatchingAttribute(this.deviceStatus.getStatusState());
        this.events.emitStatusUpdated(this.robotState);
    }
